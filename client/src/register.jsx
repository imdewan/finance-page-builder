...
function RegisterPage() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://127.0.0.1:8000/apis/register/', {
...
<div className="grid">
  ...
  <form  className="form login" onSubmit={handleSubmit}>
    ...
    <div className="form__field">
      ...
      <input  id="login__username" type="text" name="email" className="form__input" placeholder="Email" required/>
    </div>
  ...
  <p className="text--center">Already a member? <a href="/login">Sign in now</a> </p>
